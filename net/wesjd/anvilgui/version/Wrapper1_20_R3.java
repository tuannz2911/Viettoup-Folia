...
public final class Wrapper1_20_R3 implements VersionWrapper {
   ...
   public int getNextContainerId(Player player, VersionWrapper.AnvilContainerWrapper container) {
      return ((Wrapper1_20_R3.AnvilContainer)container).getContainerId();
   }
   ...
   public VersionWrapper.AnvilContainerWrapper newContainerAnvil(Player player, Object title) {
      return new Wrapper1_20_R3.AnvilContainer(player, this.getRealNextContainerId(player), (IChatBaseComponent)title);
   }
   ...
   private static class AnvilContainer extends ContainerAnvil implements VersionWrapper.AnvilContainerWrapper {
      public AnvilContainer(Player player, int containerId, IChatBaseComponent guiTitle) {
         super(containerId, ((CraftPlayer)player).getHandle().fS(), ContainerAccess.a(((CraftWorld)player.getWorld()).getHandle(), new BlockPosition(0, 0, 0)));
      ...
      public void setRenameText(String text) {
         ...
         if (inputLeft.f()) {
            inputLeft.g().a(IChatBaseComponent.b(text));
         }
