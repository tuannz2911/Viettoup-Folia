...
public class Wrapper1_15_R1 implements VersionWrapper {
   ...
   public VersionWrapper.AnvilContainerWrapper newContainerAnvil(Player player, Object guiTitle) {
      return new Wrapper1_15_R1.AnvilContainer(player, (IChatBaseComponent)guiTitle);
   }
   ...
   private class AnvilContainer extends ContainerAnvil implements VersionWrapper.AnvilContainerWrapper {
      public AnvilContainer(Player param2, IChatBaseComponent param3) {
         super(Wrapper1_15_R1.this.getRealNextContainerId(player), ((CraftPlayer)player).getHandle().inventory, ContainerAccess.at(((CraftWorld)player.getWorld()).getHandle(), new BlockPosition(0, 0, 0)));
